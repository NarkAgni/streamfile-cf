...
const BOT_TOKEN = "6439130033:AAHYoX5ShRjqxXyp24imD4h_fnDB-ts5GHU"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "ugabuga"; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 6372388205; // Insert your telegram account id.
const BOT_CHANNEL = -1002582529945; // Insert your telegram channel id which the bot is admin in.
const SIA_SECRET = "ugabugabugauga"; // Insert a powerful secret text and keep it safe.
